...
### v0.452.0 -- 2026-08-18 ([c-RCP-18-tracker] issue #533 batch REQ-I2C-*: requirement-atomicity audit, Group 2 per-endpoint)
...
combined-flag reporting-bug finding) each 100% (1253/1253 requirements,
512/512 functions).

Version 0.449.0 -> 0.452.0 (`CMakeLists.txt`/`version.h`/`.fusa.json`
...
`REQ-CANEP-*` (`v0.449.0`), `REQ-UART-*` (`v0.450.0`), and
`REQ-PWM-*` (`v0.451.0`) batches); dated `CHANGELOG.md`/`ROADMAP.md`
entries above the current highest version header in each.

Part of #533. Not closing it -- other Group 2 (`REQ-MDIO-*`,
`REQ-WAKEUP-*` -- `REQ-SPI-*`/`REQ-ADC-*`/`REQ-LINEP-*`/`REQ-GPIO-*`/
`REQ-ISELED-*`/`REQ-CANEP-*`/`REQ-UART-*`/`REQ-PWM-*` landed
