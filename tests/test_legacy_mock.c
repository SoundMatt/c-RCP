...
/* Renamed from the original tests/test_mock.c (see legacy_mock.h for why):
 * exercises the relocated legacy rcp_controller_t/rcp_registry_t reference
 * double, unchanged in behavior. tests/test_mock.c now tests the new
 * TC18-shaped mock.h/mock.c this milestone (v0.77.0) introduced instead. */
#include "unity.h"
