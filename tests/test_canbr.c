 ...
 *
 * The CAN controller is a compile-time interface stub: until a concrete
...
//cfusa:test REQ-CAN-003
//cfusa:test REQ-CAN-004
#include "unity.h"
...
{
    rcp_controller_t *ctrl = rcp_can_controller_new(RCP_ZONE_FRONT_LEFT, rcp_can_default_config());
...
{
    rcp_controller_t *ctrl = rcp_can_controller_new(RCP_ZONE_REAR_RIGHT, rcp_can_default_config());
...
{
    rcp_controller_t *ctrl = rcp_can_controller_new(RCP_ZONE_CENTRAL, rcp_can_default_config());
    rcp_context_t ctx = rcp_context_background();
...
{
    rcp_controller_t *ctrl = rcp_can_controller_new(RCP_ZONE_FRONT_RIGHT, rcp_can_default_config());
