 ...
 *
 * The UDS controller is a compile-time interface stub: until a concrete
 ...
 * undefined behaviour.
 */
//cfusa:test REQ-UDS-001
//cfusa:test REQ-UDS-002
//cfusa:test REQ-UDS-003
//cfusa:test REQ-UDS-004
#include "unity.h"
...
{
    rcp_controller_t *ctrl = rcp_uds_controller_new(RCP_ZONE_FRONT_LEFT, rcp_uds_default_config());
...
{
    rcp_controller_t *ctrl = rcp_uds_controller_new(RCP_ZONE_REAR_RIGHT, rcp_uds_default_config());
...
{
    rcp_controller_t *ctrl = rcp_uds_controller_new(RCP_ZONE_CENTRAL, rcp_uds_default_config());
    rcp_context_t ctx = rcp_context_background();
...
{
    rcp_controller_t *ctrl = rcp_uds_controller_new(RCP_ZONE_FRONT_RIGHT, rcp_uds_default_config());
