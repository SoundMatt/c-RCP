 ...
 *
 * The DDS controller is a compile-time interface stub: until a concrete
...
//cfusa:test REQ-DDS-003
//cfusa:test REQ-DDS-004
#include "unity.h"
...
{
    rcp_controller_t *ctrl = rcp_dds_controller_new(RCP_ZONE_FRONT_LEFT, rcp_dds_default_config());
...
{
    rcp_controller_t *ctrl = rcp_dds_controller_new(RCP_ZONE_REAR_RIGHT, rcp_dds_default_config());
...
{
    rcp_controller_t *ctrl = rcp_dds_controller_new(RCP_ZONE_CENTRAL, rcp_dds_default_config());
    rcp_context_t ctx = rcp_context_background();
...
{
    rcp_controller_t *ctrl = rcp_dds_controller_new(RCP_ZONE_FRONT_RIGHT, rcp_dds_default_config());
