...
direct enumeration of all 1229 entries at HEAD, after the [c-RCP-16
follow-up] issue #552 fix and the [c-RCP-18-tracker] issue #533 Group
3/Group 1/Group 2 (REQ-ACF-*, REQ-AVTP-*, REQ-RMAP-*, REQ-SPI-*,
REQ-ADC-*, REQ-GPIO-*, REQ-LINEP-*, REQ-ISELED-*, REQ-CANEP-*) requirement-atomicity splits) are:

| `scope` | Count | ASIL mix | What it actually is today |
|---|---|---|---|
| `tc18` | 1193 | 1084 ASIL-B, 36 ASIL-A, 73 QM | The shipped TC18 behavior. The 73 QM-rated entries inside this scope are optional/non-safety-relevant TC18 features (e.g. discovery cosmetics) implemented alongside the ASIL-rated core, not a separate module. |
