...
direct enumeration of all 1271 entries at HEAD, after the [c-RCP-16
follow-up] issue #552 fix and the [c-RCP-18-tracker] issue #533 Group
3/Group 1/Group 2 (REQ-ACF-*, REQ-AVTP-*, REQ-RMAP-*, REQ-SPI-*,
REQ-ADC-*, REQ-GPIO-*, REQ-LINEP-*, REQ-ISELED-*, REQ-CANEP-*, REQ-UART-*, REQ-PWM-*, REQ-MDIO-*, REQ-WAKEUP-*, REQ-I2C-*) requirement-atomicity splits) are:
